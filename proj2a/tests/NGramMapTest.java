...
public class NGramMapTest {
    ...
    public void weightHistoryTest() {
        ...
        List<Integer> expectedYears = new ArrayList<>
                (Arrays.asList(2005, 2006, 2007, 2008));
        List<Double> expectedCounts = new ArrayList<>
                (Arrays.asList(83769.0, 87688.0, 108634.0, 171015.0));

        TimeSeries wandered2005to2008 = ngm.countHistory("wandered");
        assertThat(wandered2005to2008.years()).isEqualTo(expectedYears);

        TimeSeries wanderedCount = ngm.weightHistory("wandered", 2005, 2008);
        int expectedOne = 83769 / (83769 + 87688 + 108634 + 171015);
        assertThat(wanderedCount.get(2005)).isWithin(1E-5).of(expectedOne);
    }
    ...
    public void summedWeightHistoryTest() {
        ...
        TimeSeries airportAndRequestWeight = ngm.summedWeightHistory(airportAndRequest, 2007, 2008);

        int expectedThree = (173294 + 7005265) / (175702 + 173294 + 697645 + 7005265);
        assertThat(airportAndRequestWeight.get(2008)).isWithin(1E-4).of(expectedThree);

        List<String> collectionTest = new ArrayList<>();
        collectionTest.add("airport");
        collectionTest.add("wandered");

        TimeSeries secondTest = ngm.summedWeightHistory(collectionTest);
        double expectedFour = (175702.0 + 108634) / 28307904288.0 ;
        assertThat(secondTest.get(2007)).isWithin(1E-4).of(expectedFour);
    }
}
